...
public final class GenerateConfig
{
    ...
    public static void main(final String[] args)
        throws ClassNotFoundException, NoSuchMethodException, CodecException, InstantiationException, IllegalAccessException,
               InvocationTargetException, com.github.cafapi.common.util.moduleloader.ModuleLoaderException
    {
        if (args.length < 1) {
            System.err.println("Usage: java -cp * com.github.cafapi.common.util.tools.GenerateConfig configClassName");
        } else {
