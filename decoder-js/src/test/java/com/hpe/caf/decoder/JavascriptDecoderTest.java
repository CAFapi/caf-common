...
public class JavascriptDecoderTest extends PowerMockTestCase {
    ...
    public void deserializeWithEnvironmentVariablesTest() throws CodecException {
        ...
        PowerMockito.when(PropertyRetriever.getProperty("TEST_MYINT")).thenReturn(Integer.toString(expectedMyInt));
        PowerMockito.when(PropertyRetriever.getProperty("TEST_MYSTRING")).thenReturn(expectedMyString);
        PowerMockito.when(PropertyRetriever.getProperty("TEST_MYBOOLEAN")).thenReturn(Boolean.toString(expectedMyBoolean));
        PowerMockito.when(PropertyRetriever.getProperty("TEST_MYNESTEDSTRING")).thenReturn(expectedNestedString);
        PowerMockito.when(PropertyRetriever.getProperty("TEST_MYNESTEDINT")).thenReturn(Integer.toString(expectedNestedInt));
        PowerMockito.when(PropertyRetriever.getProperty("TEST_MYNESTEDBOOLEAN")).thenReturn(Boolean.toString(expectedNestedBoolean));
