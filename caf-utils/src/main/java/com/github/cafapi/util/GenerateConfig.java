 ...
 *
 * Example usage: java -cp "*" com.github.cafapi.util.GenerateConfig com.github.workerframework.queues.RabbitWorkerQueueConfiguration
 */
public final class GenerateConfig
{
    ...
    {
        if (args.length < 1) {
            System.err.println("Usage: java -cp * com.github.cafapi.util.GenerateConfig configClassName");
        } else {
