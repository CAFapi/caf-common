...
/**
 * Partial implementation of a ManagedConfigurationSource that performs hierarchical lookups
 * based upon the service's ServicePath, and recursive lookup for configuration objects
 * that themselves have configuration in marked with the @Configuration annotation.
 * @since 9.0
 */
