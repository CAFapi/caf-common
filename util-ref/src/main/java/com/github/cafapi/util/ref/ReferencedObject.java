 ...
 */
package com.github.cafapi.util.ref;
...
public final class ReferencedObject<T>
{
    ...
    /**
     * Return the referenced object, potentially performing a remote DataStore lookup and deserialisation. If the object is already
